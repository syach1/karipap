...
class RomsRepository(
    ...
    fun romsForArtwork(platformTag: String): List<Rom> = romsForPlatform(platformTag.uppercase())
    ...
    private fun Rom.relativeAfterPlatform(): String {
        ...
        return PlatformFolderAliases.stripLeadingPlatformSegment(platformTag, rel)
    }
